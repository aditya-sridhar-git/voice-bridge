...
def _extract_emotion(audio_path: str, device: str = "cpu") -> EmotionFeatures:
    """
    Run SpeechBrain emotion classifier and return label + embedding.
    Falls back to a neutral dummy if SpeechBrain is unavailable.
    """
    try:
        import torch
        ...
        # Extract intermediate embedding from the encoder
...
def extract_features(
    ...
    emotion = _extract_emotion(audio_path, device=device)
